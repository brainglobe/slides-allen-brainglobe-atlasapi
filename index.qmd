...
- Meshes stored in a precomputed format
- Each component stored and downloaded lazily from [Amazon S3](https://open.quiltdata.com/b/brainglobe/tree/atlas/)
...
```{=html}
<iframe src="https://neuroglancer-demo.appspot.com/#!https://brainglobe.s3.amazonaws.com/ng_state_files/allen_mouse.json"
        width="135%"
        height="135%"
        style="border:none; max-height: 180%; max-width: 200%; transform: scale(0.75); transform-origin: top left;"
        allowfullscreen>
</iframe>
```
...
```{=html}
<iframe src="https://neuroglancer-demo.appspot.com/#!https://brainglobe.s3.amazonaws.com/ng_state_files/columbia_cuttlefish.json"
        width="135%"
        height="135%"
        style="border:none; max-height: 180%; max-width: 200%; transform: scale(0.75); transform-origin: top left;"
        allowfullscreen>
